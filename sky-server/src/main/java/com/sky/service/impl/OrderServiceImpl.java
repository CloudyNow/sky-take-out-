...
public class OrderServiceImpl  implements OrderService {
    ...
    @Autowired
    private ShoppingMapper shoppingCartMapper;
    @Autowired
    ...
    public void userCancelById(Long id) throws Exception {
        ...
        if (ordersDB.getStatus() > 2) {
            throw new OrderBusinessException(MessageConstant.ORDER_STATUS_ERROR);//订单状态不正确
        }

        Orders orders = new Orders();//待更新订单对象
        orders.setId(ordersDB.getId());//订单id
